...
if(isset($_POST['submit'])){
  $sql = "INSERT INTO koolitus (name, email, addres,phone )
  VALUES ('".$_POST["name"]."','".$_POST["email"]."','".$_POST["addres"]."','".$_POST["phone"]."')";
  ...
  <body>
    ...
    <form class="row g-3" method="post">
      ...
      <div class="col-md-12">
          ...
          <input type="text" name="addres" class="form-control"  placeholder="Улица, дом, кв, город, страна" required>
      </div>
