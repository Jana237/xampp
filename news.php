			...
			{	
				echo'<tbody>
					<tr>
					  <td>'.$str['title'].'</td>
					  <td>'.$str['news'].'</td>
					  <td><a href="'.$_SERVER['PHP_SELF'].'?id='.$str['id'].'">delete</a> <img src="garbage.png"></td>
					  <td><a href="edit.php?id='.$str['id'].'">edit</a> <img src="edit.png"></td>
					   <td><a href="read.php?id='.$str['id'].'">read</a>  <img src="book(1).png"></td>
					</tr>
				</tbody>';
			}
